...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'languages.aar' => 'string',
            'languages.abk' => 'string',
            'languages.afr' => 'string',
            'languages.aka' => 'string',
            'languages.amh' => 'string',
            'languages.ara' => 'string',
            'languages.arg' => 'string',
            'languages.asm' => 'string',
            'languages.ava' => 'string',
            'languages.ave' => 'string',
            'languages.aym' => 'string',
            'languages.aze' => 'string',
            'languages.bak' => 'string',
            'languages.bel' => 'string',
            'languages.bul' => 'string',
            'languages.bis' => 'string',
            'languages.bam' => 'string',
            'languages.ben' => 'string',
            'languages.bod' => 'string',
            'languages.bre' => 'string',
            'languages.bos' => 'string',
            'languages.cat' => 'string',
            'languages.che' => 'string',
            'languages.cha' => 'string',
            'languages.cos' => 'string',
            'languages.cre' => 'string',
            'languages.ces' => 'string',
            'languages.chu' => 'string',
            'languages.chv' => 'string',
            'languages.cym' => 'string',
            'languages.dan' => 'string',
            'languages.deu' => 'string',
            'languages.div' => 'string',
            'languages.dzo' => 'string',
            'languages.ell' => 'string',
            'languages.eng' => 'string',
            'languages.epo' => 'string',
            'languages.spa' => 'string',
            'languages.est' => 'string',
            'languages.eus' => 'string',
            'languages.fas' => 'string',
            'languages.ful' => 'string',
            'languages.fin' => 'string',
            'languages.fij' => 'string',
            'languages.fao' => 'string',
            'languages.fra' => 'string',
            'languages.fry' => 'string',
            'languages.gle' => 'string',
            'languages.gla' => 'string',
            'languages.glg' => 'string',
            'languages.grn' => 'string',
            'languages.guj' => 'string',
            'languages.glv' => 'string',
            'languages.hau' => 'string',
            'languages.heb' => 'string',
            'languages.hin' => 'string',
            'languages.hmo' => 'string',
            'languages.hrv' => 'string',
            'languages.hat' => 'string',
            'languages.hun' => 'string',
            'languages.hye' => 'string',
            'languages.her' => 'string',
            'languages.ina' => 'string',
            'languages.ind' => 'string',
            'languages.ile' => 'string',
            'languages.ibo' => 'string',
            'languages.iii' => 'string',
            'languages.iku' => 'string',
            'languages.ipk' => 'string',
            'languages.ido' => 'string',
            'languages.isl' => 'string',
            'languages.ita' => 'string',
            'languages.jpn' => 'string',
            'languages.jav' => 'string',
            'languages.kat' => 'string',
            'languages.kon' => 'string',
            'languages.kik' => 'string',
            'languages.kua' => 'string',
            'languages.kaz' => 'string',
            'languages.kal' => 'string',
            'languages.khm' => 'string',
            'languages.kan' => 'string',
            'languages.kor' => 'string',
            'languages.kau' => 'string',
            'languages.kas' => 'string',
            'languages.kur' => 'string',
            'languages.kom' => 'string',
            'languages.cor' => 'string',
            'languages.kir' => 'string',
            'languages.lat' => 'string',
            'languages.ltz' => 'string',
            'languages.lug' => 'string',
            'languages.lim' => 'string',
            'languages.lin' => 'string',
            'languages.lao' => 'string',
            'languages.lit' => 'string',
            'languages.lub' => 'string',
            'languages.lav' => 'string',
            'languages.mlg' => 'string',
            'languages.mah' => 'string',
            'languages.mri' => 'string',
            'languages.mkd' => 'string',
            'languages.mal' => 'string',
            'languages.mon' => 'string',
            'languages.mar' => 'string',
            'languages.msa' => 'string',
            'languages.mlt' => 'string',
            'languages.mya' => 'string',
            'languages.nau' => 'string',
            'languages.nob' => 'string',
            'languages.nde' => 'string',
            'languages.nep' => 'string',
            'languages.ndo' => 'string',
            'languages.nld' => 'string',
            'languages.nno' => 'string',
            'languages.nor' => 'string',
            'languages.nbl' => 'string',
            'languages.nav' => 'string',
            'languages.nya' => 'string',
            'languages.oci' => 'string',
            'languages.oji' => 'string',
            'languages.orm' => 'string',
            'languages.ori' => 'string',
            'languages.oss' => 'string',
            'languages.pan' => 'string',
            'languages.pli' => 'string',
            'languages.pol' => 'string',
            'languages.pus' => 'string',
            'languages.por' => 'string',
            'languages.que' => 'string',
            'languages.roh' => 'string',
            'languages.run' => 'string',
            'languages.ron' => 'string',
            'languages.rus' => 'string',
            'languages.kin' => 'string',
            'languages.san' => 'string',
            'languages.srd' => 'string',
            'languages.snd' => 'string',
            'languages.sme' => 'string',
            'languages.sag' => 'string',
            'languages.sin' => 'string',
            'languages.slk' => 'string',
            'languages.slv' => 'string',
            'languages.smo' => 'string',
            'languages.sna' => 'string',
            'languages.som' => 'string',
            'languages.sqi' => 'string',
            'languages.srp' => 'string',
            'languages.ssw' => 'string',
            'languages.sot' => 'string',
            'languages.sun' => 'string',
            'languages.swe' => 'string',
            'languages.swa' => 'string',
            'languages.tam' => 'string',
            'languages.tel' => 'string',
            'languages.tgk' => 'string',
            'languages.tha' => 'string',
            'languages.tir' => 'string',
            'languages.tuk' => 'string',
            'languages.tgl' => 'string',
            'languages.tsn' => 'string',
            'languages.ton' => 'string',
            'languages.tur' => 'string',
            'languages.tso' => 'string',
            'languages.tat' => 'string',
            'languages.twi' => 'string',
            'languages.tah' => 'string',
            'languages.uig' => 'string',
            'languages.ukr' => 'string',
            'languages.urd' => 'string',
            'languages.uzb' => 'string',
            'languages.ven' => 'string',
            'languages.vie' => 'string',
            'languages.vol' => 'string',
            'languages.wln' => 'string',
            'languages.wol' => 'string',
            'languages.xho' => 'string',
            'languages.yid' => 'string',
            'languages.yor' => 'string',
            'languages.zha' => 'string',
            'languages.zho' => 'string',
            'languages.zul' => 'string',
...
'fortify.domain','fortify.lowercase_usernames','fortify.limiters.login','fortify.limiters.passkeys','fortify.paths.login',
...
'fortify.passkeys.user_handle_secret','fortify.passkeys.timeout','fortify.features','inertia.ssr.enabled','inertia.ssr.url',
...
'languages.aar','languages.abk','languages.afr','languages.aka','languages.amh',
'languages.ara','languages.arg','languages.asm','languages.ava','languages.ave',
'languages.aym','languages.aze','languages.bak','languages.bel','languages.bul',
'languages.bis','languages.bam','languages.ben','languages.bod','languages.bre',
'languages.bos','languages.cat','languages.che','languages.cha','languages.cos',
'languages.cre','languages.ces','languages.chu','languages.chv','languages.cym',
'languages.dan','languages.deu','languages.div','languages.dzo','languages.ell',
'languages.eng','languages.epo','languages.spa','languages.est','languages.eus',
'languages.fas','languages.ful','languages.fin','languages.fij','languages.fao',
'languages.fra','languages.fry','languages.gle','languages.gla','languages.glg',
'languages.grn','languages.guj','languages.glv','languages.hau','languages.heb',
'languages.hin','languages.hmo','languages.hrv','languages.hat','languages.hun',
'languages.hye','languages.her','languages.ina','languages.ind','languages.ile',
'languages.ibo','languages.iii','languages.iku','languages.ipk','languages.ido',
'languages.isl','languages.ita','languages.jpn','languages.jav','languages.kat',
'languages.kon','languages.kik','languages.kua','languages.kaz','languages.kal',
'languages.khm','languages.kan','languages.kor','languages.kau','languages.kas',
'languages.kur','languages.kom','languages.cor','languages.kir','languages.lat',
'languages.ltz','languages.lug','languages.lim','languages.lin','languages.lao',
'languages.lit','languages.lub','languages.lav','languages.mlg','languages.mah',
'languages.mri','languages.mkd','languages.mal','languages.mon','languages.mar',
'languages.msa','languages.mlt','languages.mya','languages.nau','languages.nob',
'languages.nde','languages.nep','languages.ndo','languages.nld','languages.nno',
'languages.nor','languages.nbl','languages.nav','languages.nya','languages.oci',
'languages.oji','languages.orm','languages.ori','languages.oss','languages.pan',
'languages.pli','languages.pol','languages.pus','languages.por','languages.que',
'languages.roh','languages.run','languages.ron','languages.rus','languages.kin',
'languages.san','languages.srd','languages.snd','languages.sme','languages.sag',
'languages.sin','languages.slk','languages.slv','languages.smo','languages.sna',
'languages.som','languages.sqi','languages.srp','languages.ssw','languages.sot',
'languages.sun','languages.swe','languages.swa','languages.tam','languages.tel',
'languages.tgk','languages.tha','languages.tir','languages.tuk','languages.tgl',
'languages.tsn','languages.ton','languages.tur','languages.tso','languages.tat',
'languages.twi','languages.tah','languages.uig','languages.ukr','languages.urd',
'languages.uzb','languages.ven','languages.vie','languages.vol','languages.wln',
'languages.wol','languages.xho','languages.yid','languages.yor','languages.zha',
'languages.zho','languages.zul','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'queue.connections.rabbitmq.hosts.0.user','queue.connections.rabbitmq.hosts.0.password','queue.connections.rabbitmq.hosts.0.vhost','queue.connections.rabbitmq.options','queue.connections.rabbitmq.worker',
...
'blueprint.namespace','blueprint.models_namespace','blueprint.controllers_namespace','blueprint.components_namespace','blueprint.policy_namespace',
'blueprint.app_path','blueprint.generate_phpdocs','blueprint.use_constraints','blueprint.on_delete','blueprint.on_update',
'blueprint.fake_nullables','blueprint.use_guarded','blueprint.types.primary','blueprint.types.timestamps','blueprint.singular_routes',
...
'password.confirm','password.confirmation','password.confirm.store','passkey.login-options','passkey.login',
'passkey.confirm-options','passkey.confirm','passkey.registration-options','passkey.store','passkey.destroy','home','dashboard','profile.edit',
...
'LOG_LEVEL','DB_CONNECTION','DB_HOST','FORWARD_DB_PORT','DB_PORT',
...
'VITE_APP_NAME','VITE_PORT','SCOUT_DRIVER','MEILISEARCH_HOST','FORWARD_MEILISEARCH_PORT',
'MEILISEARCH_NO_ANALYTICS','QUEUE_CONNECTION','RABBITMQ_VHOST','RABBITMQ_HOST','RABBITMQ_PORT',
'RABBITMQ_USER','RABBITMQ_PASSWORD','RABBITMQ_QUEUE','FORWARD_REDIS_PORT','FFMPEG_BIN',);
